...
router.post('/', guard.jwt, joiMiddleware(monitorSchema.createMonitor), monitorController.createMonitor)
router.put('/:id', guard.jwt, joiMiddleware(monitorSchema.updateMonitor), monitorController.updateMonitor)
